  ...
  return (
    <div data-testid="cena-sughi-page" className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      ...
      <div className="flex gap-2">
        ...
        {tabBtn("sughi", tri("Sughi nel mondo", "Soßen der Welt", "Sauces of the world"), "cena-tab-sughi")}
      </div>
      ...
      {tab === "sughi" && (
        <section data-testid="cena-sughi" className="space-y-3">
          <p className="text-sm text-muted-foreground">
            {tri("Sughi e salse dall'Italia e dal mondo, per 4 persone. Tocca una scheda per aprirla.", "Soßen aus Italien und der Welt, für 4 Personen. Tippe auf eine Karte, um sie zu öffnen.", "Sauces from Italy and around the world, for 4 people. Tap a card to open it.")}
          </p>
          {SAUCES.map((s) => {
