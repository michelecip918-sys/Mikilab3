        ...
        <div className="space-y-3 py-1">
          ...
          <div>
            ...
            >
              ...
              <option value="rosticceria">🥧 {mkTri(lang)("Rosticceria & Salati", "Rosticceria & Herzhaftes", "Rosticceria & Savoury", "Rosticería y Salados", "Rôtisserie & Salés")}</option>
              <option value="fritti">🍤 {mkTri(lang)("Fritti & Panzerotti", "Frittiertes & Panzerotti", "Fried & Panzerotti", "Fritos y Panzerotti", "Fritures & Panzerotti")}</option>
            </select>
          </div>
