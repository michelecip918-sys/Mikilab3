#!/bin/sh
# MikiLab v88 (include v84, v85, v86). Solo frontend. Uso dalla radice del progetto:  sh patch88/applica.sh
set -e
...
for f in LaTuaBottega FestaLancio Volantino AscoltaCrosta SvegliaPanettiere PaneDelPaese SenzaBilancia CuraLievito MioLievito MappaForno PrimoGiro LancioSegreto BancoProve MioForno; do
...
echo "OK: v88 applicata. Ora: cd frontend && yarn build (deve riuscire), poi un solo commit e un solo deploy. Poi reinvia la sitemap in Search Console."
