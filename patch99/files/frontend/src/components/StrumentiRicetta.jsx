...
import { Thermometer, Clock, Ruler, Scale, Euro, Calendar, Gift, Layers, Scissors, ChevronDown, BookOpen, AlertTriangle, Wine, NotebookPen, Coffee } from "lucide-react";
...
import MieiAppunti from "@/components/officina/MieiAppunti"; // V98
import TazzeOnce from "@/components/officina/TazzeOnce"; // V98
...
export default function StrumentiRicetta({ r, t, target, scaleVal, onScaleChange }) {
  ...
  const tools = [
    { k: "appunti", I: NotebookPen, l: tri("I miei appunti", "Meine Notizen", "My notes"), C: () => <MieiAppunti r={r} lang={lang} /> },
    ...
    { k: "tazze", I: Coffee, l: tri("In tazze e once", "In Cups und Unzen", "In cups and ounces"), C: () => <TazzeOnce r={r} dough={dough} lang={lang} t={t} /> },
