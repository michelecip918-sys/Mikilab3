...
export const ENC_ENTRIES = {
  it: [
    ...
    { t: "Farine speciali", b: "Ogni farina cambia l'impasto. Farro (Dinkel): profumato ma con glutine più fragile → impasto delicato, acqua −8% (il pulsante «Converti in farro» sulla ricetta lo fa da solo). Segale: poco glutine, molto attiva → prefermenti liquidi e idratazioni alte. Integrale/Vollkorn: crusca che 'taglia' il glutine e beve acqua → più idratazione e riposi. Tipo 00/0/1/2: dal più raffinato al quasi integrale. Manitoba (alta W): forte, per grandi lievitati." },
  ...
  es: [
    ...
    { t: "Harinas especiales", b: "Cada harina cambia la masa. Espelta (Dinkel): aromática pero con gluten más frágil → masa delicada, agua −8% (el botón «Convertir a espelta» de la receta lo hace solo). Centeno: poco gluten, muy activo → prefermentos líquidos e hidrataciones altas. Integral/Vollkorn: el salvado 'corta' el gluten y absorbe agua → más hidratación y reposos. Tipo 00/0/1/2: de la más refinada a la casi integral. Manitoba (alta W): fuerte, para grandes lievitados." },
  ...
  en: [
    ...
    { t: "Special flours", b: "Every flour changes the dough. Spelt (Dinkel): fragrant but more fragile gluten → gentle mixing, 8% less water (the «Convert to Spelt» button on the recipe does it for you). Rye: little gluten, very active → liquid preferments and high hydration. Wholemeal: bran that 'cuts' the gluten and drinks water → more hydration and rests. Type 00/0/1/2: from most refined to nearly wholemeal. Manitoba (high W): strong, for big leavened cakes." },
