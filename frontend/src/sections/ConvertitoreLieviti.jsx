...
export default function ConvertitoreLieviti({ onBack }) {
  ...
  return (
    <div className="pb-8" data-testid="conv-lieviti">
      ...
      {/* 3 */}
      <div className={card}>
        <p className="font-display text-base font-bold text-[#ff6b00] mb-2 flex items-center gap-1.5"><Droplets className="w-4.5 h-4.5" /> {L("Converti il prefermento (idratazione)", "Vorteig umrechnen (Hydratation)", "Convert preferment (hydration)", "Convertir prefermento (hidratación)")}</p>
