  ...
  return (
    <div className="pb-8" data-testid="conv-lieviti">
      ...
      <div className={card + " mb-3"}>
        <p className="font-display text-base font-bold text-[#3E9C93] mb-2 flex items-center gap-1.5"><Beaker className="w-4.5 h-4.5" /> {L("Lievito di birra: fresco ⇄ secco", "Hefe: frisch ⇄ trocken", "Yeast: fresh ⇄ dry", "Levadura: fresca ⇄ seca")}</p>
      ...
      {/* 2 */}
      <div className={card + " mb-3"}>
        <p className="font-display text-base font-bold text-[#3E9C93] mb-2">{L("Da lievito di birra a Lievito Madre", "Von Hefe zu Sauerteig", "From yeast to sourdough", "De levadura a masa madre")}</p>
        <div className="grid grid-cols-2 gap-3 items-end">
      ...
      {/* 3 */}
      <div className={card}>
        <p className="font-display text-base font-bold text-[#3E9C93] mb-2 flex items-center gap-1.5"><Droplets className="w-4.5 h-4.5" /> {L("Converti il prefermento (idratazione)", "Vorteig umrechnen (Hydratation)", "Convert preferment (hydration)", "Convertir prefermento (hidratación)")}</p>
        ...
        <div data-testid="conv-pref-out" className="rounded-2xl shadow-md border border-amber-900/40 bg-[#ffffff] p-3 text-[13px] text-[#3E9C93] font-semibold space-y-1">
