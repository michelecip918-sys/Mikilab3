    ...
    <div data-testid="sfida-lampo" className="mb-5 rounded-3xl overflow-hidden border border-[#3E9C93]/40 bg-[#1B2A38] shadow-lg">
      ...
      <div className="p-4 space-y-3">
        <div className="flex items-center justify-between text-[12px] text-[#AEB8BF]">
          <span className="inline-flex items-center gap-1.5"><Users className="w-4 h-4 text-[#3E9C93]" /> {data?.participants || 0} {L("fornai in gara", "Bäcker dabei", "bakers competing", "panaderos compitiendo", "boulangers en lice", "نانوا در رقابت")}</span>
        </div>
        ...
        <div data-testid="sfida-lampo-leaderboard">
          <p className="text-[11px] font-extrabold uppercase tracking-wider text-[#3E9C93] flex items-center gap-1.5 mb-2 mt-1"><Trophy className="w-4 h-4" /> {L("Classifica dei fornai", "Bäcker-Rangliste", "Bakers leaderboard", "Clasificación de panaderos", "Classement des boulangers", "جدول نانواها")}</p>
          {entries.length === 0 ? (
