...
export default function SoundDiagnosi() {
  ...
  return (
    <div className="pb-24">
      <div className="relative rounded-3xl overflow-hidden mb-5 bg-gradient-to-br from-[#B45309] to-[#6E371C] p-6 text-white">
      ...
      <div className="rounded-2xl bg-[#B45309]/12 border border-[#B45309]/30 p-4 mb-4 text-sm text-[#6E371C] dark:text-[#8FB0C2] leading-relaxed">
      ...
      {recording && (
        <div data-testid="sound-wave" className="mt-4 rounded-2xl bg-[#6E371C] p-4">
      ...
      {result && (
        <div className="mt-5">
          <div data-testid="sound-result" className="markdown-body bg-white dark:bg-[#232A31] border border-[#E6D8C3] dark:border-[#38424B] rounded-2xl p-5 text-sm leading-relaxed text-[#2B303B] dark:text-[#e4eff8]">
          ...
          <ListenButton text={result} who="momy" testid="sound-listen-btn"
            className="mt-2 w-full bg-[#8C4A27] hover:bg-[#336a94] text-white font-medium px-4 py-3 rounded-2xl flex items-center justify-center gap-2 active:scale-98 transition-all" />
        </div>
      )}
    </div>
  );
