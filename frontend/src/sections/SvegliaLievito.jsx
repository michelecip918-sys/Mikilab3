  ...
  return (
    <div className="pb-4">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold text-[#2B303B] dark:text-[#EAF0EC]">{t("sv_title")}</h1>
      ...
      <div
        ...
        className={`rounded-3xl p-6 text-white shadow-lg mb-4 ${due ? "bg-gradient-to-br from-[#C0574D] to-[#33564E]" : "bg-gradient-to-br from-[#6B8E62] to-[#4d6b45]"}`}
      >
      ...
      <div className="bg-white dark:bg-[#232A31] border border-[#D7E1DB] dark:border-[#38424B] rounded-2xl p-4 mb-3">
        ...
        <div className="flex items-center gap-2 mt-2">
          <input
            ...
            className="w-20 text-center font-mono-data font-bold text-[#33564E] dark:text-[#8FB0C2] bg-[#EAF0EC] dark:bg-[#2A323A] border border-[#D7E1DB] dark:border-[#38424B] rounded-lg px-2 py-2 outline-none"
          />
      ...
      <button
        ...
        className="w-full mb-3 bg-[#5E8B7E] hover:bg-[#4C7368] text-white font-semibold px-5 py-3.5 rounded-2xl shadow-md active:scale-98 transition-all flex items-center justify-center gap-2"
      >
      ...
      <div className="flex items-center gap-2 bg-white dark:bg-[#232A31] border border-[#D7E1DB] dark:border-[#38424B] rounded-2xl px-4 py-3">
        ...
        <button
          ...
          className={`w-11 h-6 rounded-full transition-colors relative ${remind ? "bg-[#6B8E62]" : "bg-[#AEB8BF] dark:bg-[#38424B]"}`}
