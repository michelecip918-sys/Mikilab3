  ...
  return (
    <div className="pb-4">
      ...
      <div
        ...
        className={`rounded-3xl p-6 text-white shadow-lg mb-4 ${due ? "bg-gradient-to-br from-[#3E9C93] to-[#3E9C93]" : "bg-gradient-to-br from-[#3E9C93] to-[#3E9C93]"}`}
      >
      ...
      <div className="bg-white dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] rounded-2xl p-4 mb-3">
        ...
        <div className="flex items-center gap-2 mt-2">
          <input
            ...
            className="w-20 text-center font-mono-data font-bold text-[#3E9C93] dark:text-[#8FB0C2] bg-[#e4eff8] dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] rounded-lg px-2 py-2 outline-none"
          />
      ...
      <div className="flex items-center gap-2 bg-white dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] rounded-2xl px-4 py-3">
        ...
        <button
          ...
          className={`w-11 h-6 rounded-full transition-colors relative ${remind ? "bg-[#3E9C93]" : "bg-[#AEB8BF] dark:bg-[#2A3B49]"}`}
