  ...
  return (
    <div className="pb-4">
      ...
      <div
        ...
        className={`rounded-3xl p-6 text-white shadow-lg mb-4 ${due ? "bg-gradient-to-br from-[#C0574D] to-[#6E371C]" : "bg-gradient-to-br from-[#B45309] to-[#8C4A27]"}`}
      >
      ...
      <div className="bg-white dark:bg-[#232A31] border border-[#E6D8C3] dark:border-[#38424B] rounded-2xl p-4 mb-3">
        ...
        <div className="flex items-center gap-2 mt-2">
          <input
            ...
            className="w-20 text-center font-mono-data font-bold text-[#6E371C] dark:text-[#8FB0C2] bg-[#e4eff8] dark:bg-[#2A323A] border border-[#E6D8C3] dark:border-[#38424B] rounded-lg px-2 py-2 outline-none"
          />
      ...
      <button
        ...
        className="w-full mb-3 bg-[#8C4A27] hover:bg-[#336a94] text-white font-semibold px-5 py-3.5 rounded-2xl shadow-md active:scale-98 transition-all flex items-center justify-center gap-2"
      >
      ...
      <div className="flex items-center gap-2 bg-white dark:bg-[#232A31] border border-[#E6D8C3] dark:border-[#38424B] rounded-2xl px-4 py-3">
        ...
        <button
          ...
          className={`w-11 h-6 rounded-full transition-colors relative ${remind ? "bg-[#B45309]" : "bg-[#AEB8BF] dark:bg-[#38424B]"}`}
