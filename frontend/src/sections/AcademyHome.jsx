          ...
          <div className="rounded-2xl bg-white dark:bg-[#232A31] border border-[#E6D8C3] dark:border-[#38424B] p-5 text-center">
            ...
            {typeof diagLimit === "number" && diagLimit > 0 && diagUsed >= diagLimit ? (
              <div data-testid="diagnosi-limit-upsell" className="mt-4 rounded-2xl bg-[#2e3d4c]/10 border border-[#2e3d4c]/30 p-4">
                <p className="text-sm font-semibold text-[#2e3d4c]">{tri("Hai finito le Diagnosi del mese!", "Deine Diagnosen sind aufgebraucht!", "You've used all your diagnoses this month!")}</p>
                ...
                <button data-testid="diagnosi-upgrade-pro" onClick={upgradePro}
                  className="mt-3 inline-flex items-center gap-2 bg-[#2e3d4c] hover:bg-[#963c1f] text-white font-semibold px-4 py-2.5 rounded-xl active:scale-98 transition-all">
