  ...
  return (
    <div className="pb-40">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-11 h-11 rounded-2xl bg-[#ff6b00] flex items-center justify-center"><CalendarClock className="w-6 h-6 text-white" /></div>
        <div>
      ...
      <div data-testid="sl-result" className="mt-5 rounded-3xl bg-gradient-to-br from-[#ff6b00] to-[#374f31] text-white p-6 text-center shadow-lg">
      ...
      <div data-testid="sl-badge" className={`mt-4 rounded-2xl p-4 flex items-center gap-3 border ${highDigest ? "bg-[#ff6b00]/12 border-[#ff6b00]/40" : "bg-white dark:bg-[#1e1e1e] border-[#2b2b2b] dark:border-[#2e2e2e]"}`}>
        ...
        <div>
          {highDigest ? (
            <>
              <p className="font-display font-bold text-[#ff6b00] dark:text-[#a9d2ec]">{tri("Alta Digeribilità", "Hohe Verdaulichkeit", "High Digestibility")}</p>
