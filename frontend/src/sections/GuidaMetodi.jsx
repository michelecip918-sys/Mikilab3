...
export const SECTIONS = [
  {
    ...
    es: { title: "Poolish", body: "El poolish es un prefermento LÍQUIDO: partes iguales de harina y agua (100% de hidratación) con muy poca levadura. Reposa 8-16 horas a temperatura ambiente hasta que esté lleno de burbujas y ligeramente hundido en el centro.\n\nPara qué sirve: más aroma, miga más blanda, mejor digestibilidad y corteza más crujiente. Ideal para baguettes, chapatas y panes esponjosos.\n\nRegla de oro: cuando lo añades a la masa, resta del total la harina y el agua que ya contiene el poolish para no equivocar la hidratación." },
  },
  {
    id: "lm", icon: "🌾",
    ...
    es: { title: "Masa madre — pan vs. panettone", body: "La masa madre es harina + agua fermentada por levaduras y bacterias naturales. PERO se gestiona de forma DISTINTA según lo que vayas a hacer:\n\n🍞 PARA EL PAN: puede ser más ácida y más hidratada (incluso líquida, licoli). Bastan 1-2 refrescos y algo de acidez es una virtud: da sabor, alveolatura y conservación. Gestión sencilla.\n\n🎁 PARA EL PANETTONE: necesitas una MASA MADRE SÓLIDA (atada), poco ácida y con muchísima fuerza. Se refresca VARIAS veces al día (hasta 3), a menudo con el 'baño' en agua y azúcar y atada bien fuerte en un paño. ¿Por qué? La masa del panettone es riquísima en mantequilla, yemas y azúcar: pesa mucho sobre la levadura. Si la madre está ácida o débil, el panettone no sube y sabe ácido. Así que para el panettone la madre debe ser dulce, fuerte y limpia." },
  },
  {
    id: "roggen", icon: "🟤",
    ...
    es: { title: "Masa madre de centeno (Roggen Sauerteig)", body: "Es la masa madre natural de CENTENO, típica del pan alemán. El centeno tiene muy poco gluten y muchas enzimas: sin acidez la masa quedaría pegajosa y la miga gomosa.\n\nPara qué sirve: la acidez 'bloquea' esas enzimas, da estructura, el típico sabor intenso y una conservación larguísima. Se usa para Roggenbrot, Mischbrot y panes oscuros.\n\nGestión: refresca con harina de centeno y agua, ~26-28°C, 12-16 horas de maduración. Más caliente = más ácido láctico (suave); más frío = más ácido acético (punzante)." },
  },
  {
    id: "backmittel", icon: "✨",
    ...
    es: { title: "Backmittel (mejorante natural)", body: "El Backmittel es un mejorante. El MÍO es NATURAL, sin aditivos químicos: una mezcla de ingredientes como malta de cebada, un poco de masa madre seca, semillas molidas y a veces lecitina natural.\n\nPara qué sirve: favorece el desarrollo, el dorado (la malta aporta azúcares), la esponjosidad y la conservación, de forma genuina. Se dosifica en un pequeño porcentaje sobre la harina (alrededor del 2-3%).\n\nDiferencia: los mejorantes industriales usan aditivos y enzimas químicas; el mío se basa solo en ingredientes naturales y en el método indirecto." },
  },
];
    ...
    <div className="pb-24">
      ...
      <div className="space-y-3">
        {SECTIONS.map((s) => {
          ...
          return (
            <div key={s.id} data-testid={`guida-${s.id}`} className="rounded-2xl bg-white dark:bg-[#18202E] border border-[#26324A] dark:border-[#26324A] overflow-hidden">
