...
export default function Maestro() {
  ...
  const STEPS = [
    { icon: Sparkles, title: tri("Piano di Produzione", "Produktionsplan", "Production Plan"), sub: tri("Il cuore del laboratorio: inserisci le ricette, organizza settimana, giornata e punti vendita e genera tutta la produzione da un unico posto", "Das Herz der Backstube: Rezepte erfassen, Woche/Tag/Verkaufspunkte organisieren und die gesamte Produktion an einem Ort generieren", "The heart of the lab: add recipes, organize week/day/sales points and generate the whole production from one place"), tools: ["pianoai", "settimana", "lavoro", "inversa", "spesa", "foodcost", "salespoints", "turni", "enterprise"], pianoHub: true, flourTable: true },
    { icon: Cog, title: tri("Laboratorio & Chiusura", "Backstube & Abschluss", "Lab & Closing"), sub: tri("Macchine e strumenti, operatività in corso, diagnosi e chiusura della giornata", "Maschinen und Werkzeuge, laufender Betrieb, Diagnose und Tagesabschluss", "Machines and tools, live operations, diagnosis and day closing"), tools: ["adatta", "capo", "freezer", "bilancia", "termo", "market", "acqua", "pesata", "timer", "meteo", "ph", "twin", "diagnosi", "suono", "sessioni", "lotti", "haccp", "check", "shelf", "spreco"], diagnosiInfo: true, conclusione: true },
  ];
