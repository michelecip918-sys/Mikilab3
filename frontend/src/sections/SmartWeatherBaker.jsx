...
export default function SmartWeatherBaker({ onBack }) {
  ...
  return (
    <div className="pb-8" data-testid="weather-baker">
      ...
      <div data-testid="weather-result" className="rounded-2xl bg-[#ffffff] border border-[#2A3B49] p-4 space-y-3">
        <div className="flex items-center gap-2">
          <Droplets className="w-5 h-5 text-[#3E9C93]" />
          <p className="text-[13.5px] text-[#3E9C93]"><span className="font-bold text-[#3E9C93]">{L("Acqua:", "Wasser:", "Water:", "Agua:")} </span>
        ...
        <div className="flex items-center gap-2">
          <Clock className="w-5 h-5 text-[#3E9C93]" />
          <p className="text-[13.5px] text-[#3E9C93]"><span className="font-bold text-[#3E9C93]">{L("Puntata stimata:", "Stockgare:", "Bulk proof:", "Fermentación:")} </span>
