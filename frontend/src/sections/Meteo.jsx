  ...
  return (
    <div className="pb-40">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-11 h-11 rounded-2xl bg-[#3E9C93] flex items-center justify-center"><CloudSun className="w-6 h-6 text-white" /></div>
        <div>
      ...
      <div className="grid grid-cols-[1fr_auto] gap-2 mb-3">
        ...
        <button data-testid="meteo-search" onClick={searchCity} disabled={loading}
          className="px-4 rounded-2xl shadow-md border border-amber-900/40 bg-white dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] font-semibold text-[#2B303B] dark:text-[#e4eff8] disabled:opacity-50">
      ...
      {w && (
        <>
          ...
          <div data-testid="meteo-advice" className="space-y-3">
            <div className="rounded-2xl bg-white dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl shadow-md border border-amber-900/40 bg-[#3E9C93]/15 flex items-center justify-center shrink-0"><Droplets className="w-5 h-5 text-[#3E9C93]" /></div>
            ...
            <div className="rounded-2xl bg-white dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl shadow-md border border-amber-900/40 bg-[#3E9C93]/15 flex items-center justify-center shrink-0"><Timer className="w-5 h-5 text-[#3E9C93]" /></div>
              <div className="min-w-0">
