...
export default function Meteo() {
  ...
  const inp = "w-full bg-[#121212] dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] rounded-2xl shadow-md border border-amber-900/40 px-3 py-2.5 font-mono-data outline-none text-[#2B303B] dark:text-[#e4eff8] focus:border-[#ff6b00]";
        ...
        <>
          ...
          <div data-testid="meteo-advice" className="space-y-3">
            <div className="rounded-2xl bg-white dark:bg-[#1e1e1e] border border-[#2e2e2e] dark:border-[#2e2e2e] p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl shadow-md border border-amber-900/40 bg-[#ff6b00]/15 flex items-center justify-center shrink-0"><Droplets className="w-5 h-5 text-[#ff6b00]" /></div>
            ...
            <div className="rounded-2xl bg-white dark:bg-[#1e1e1e] border border-[#2e2e2e] dark:border-[#2e2e2e] p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl shadow-md border border-amber-900/40 bg-[#ff6b00]/15 flex items-center justify-center shrink-0"><Timer className="w-5 h-5 text-[#ff6b00]" /></div>
              <div className="min-w-0">
