...
export default function ScopriMikiLab() {
  ...
  return (
    <div className="space-y-5" data-testid="scopri-mikilab">
      <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-[#c94f00] to-[#c94f00] text-white shadow-xl">
      ...
      <div data-testid="scopri-timeline" className="rounded-2xl border border-[#2e2e2e] dark:border-[#2e2e2e] bg-white dark:bg-[#1e1e1e] p-4">
        <p className="font-display text-lg font-bold text-[#c94f00] dark:text-[#e4eff8] mb-3">{L("Il racconto in viaggio", "Die Reise-Geschichte", "The journey story", "El relato del viaje")}</p>
        <div className="relative pl-6">
          <div className="absolute left-[7px] top-1 bottom-1 w-0.5 bg-[#c94f00]/30" />
          {[
            ...
            <div key={i} className="relative mb-4 last:mb-0">
              <span className="absolute -left-6 top-0.5 w-4 h-4 rounded-full bg-[#c94f00] border-2 border-white dark:border-[#1e1e1e]" />
