    ...
    <div data-testid="public-batch" className="fixed inset-0 z-[75] bg-[#121212] dark:bg-[#121212] overflow-auto">
      <div className="max-w-md mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-6">
          <img src={`${process.env.PUBLIC_URL}/logo.png`} alt="MikiLab" className="w-12 h-12 rounded-xl object-cover ring-2 ring-[#ffc700]/60" onError={(e) => { e.currentTarget.style.display = "none"; }} />
          <div>
