  ...
  return (
    <div className="pb-4">
      ...
      <div className="space-y-2 mt-4">
        {rows.map((r) => (
          <div key={r.id} className="flex items-center gap-2 bg-white dark:bg-[#232A31] border border-[#d5e4f0] dark:border-[#38424B] rounded-2xl px-3 py-2.5">
            <select
      ...
      {plan && (
        <div data-testid="plan-result" className="mt-5 space-y-2">
          ...
          {plan.items.map((it, i) => {
            ...
            return (
            <div key={i} className="flex items-center gap-3 bg-white dark:bg-[#232A31] border border-[#d5e4f0] dark:border-[#38424B] rounded-2xl px-4 py-3">
              <div className="w-8 h-8 rounded-full bg-[#6E8CA0]/20 text-[#234b6e] dark:text-[#8FB0C2] font-mono-data font-bold text-sm flex items-center justify-center shrink-0">{i + 1}</div>
              <div className="flex-1 min-w-0">
                ...
                <p data-testid={`inf-bake-${i}`} className="font-mono-data text-xs text-[#234b6e] dark:text-[#8FB0C2] mt-0.5">
          ...
          <div className="flex items-center gap-3 bg-[#3f7cac] rounded-2xl px-4 py-3 text-white">
          ...
          {selectedOven && (
            <div data-testid="inf-oven-suggestion" className="bg-white dark:bg-[#232A31] border border-[#d5e4f0] dark:border-[#38424B] rounded-2xl p-4">
              <div className="flex items-center gap-2 mb-2">
                <Flame className="w-4 h-4 text-[#3f7cac]" />
                <span className="text-xs font-bold uppercase tracking-wide text-[#234b6e] dark:text-[#8FB0C2]">
              ...
              {[["phase1", t("tl_phase1")], ["phase2", t("tl_phase2")], ["phase3", t("tl_phase3")]].map(([k, label]) => {
                ...
                return (
                  <div key={k} className="flex items-center justify-between font-mono-data text-sm py-0.5">
                    ...
                    <span className="text-[#234b6e] dark:text-[#8FB0C2] font-bold">
