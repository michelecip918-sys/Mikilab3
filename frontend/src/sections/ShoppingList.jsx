    ...
    <div className="pb-4">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-[#8C7567]">{lang === "de" ? "Zutaten aus dem Wochenplan" : lang === "en" ? "Ingredients from the weekly plan" : "Ingredienti dal piano settimanale"}</p>
        </div>
      </div>
      ...
      {loaded && !hasData ? (
        <div className="flex items-start gap-3 bg-[#D99B26]/15 border border-[#D99B26]/30 rounded-2xl p-4">
          ...
          <p className="text-sm text-[#4A3B34] dark:text-[#C9BBB0]">{lang === "de" ? "Kein Wochenplan gefunden. Trage zuerst Produkte in 'Woche planen' ein und speichere." : lang === "en" ? "No plan found. First add products in 'Plan the Week' and save." : "Nessun piano trovato. Inserisci prima i prodotti in 'Pianifica la Settimana' e salva."}</p>
        </div>
      ) : (
