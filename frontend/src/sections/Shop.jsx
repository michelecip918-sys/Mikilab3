...
export default function Shop({ onNavigate }) {
  ...
  return (
    <div data-testid="shop-page" className="pb-4 space-y-6">
      <div className="rounded-3xl bg-gradient-to-br from-[#d4a373] to-[#c94f00] text-white p-7 text-center shadow-xl">
      ...
      <div data-testid="shop-free-block" className="rounded-3xl bg-gradient-to-br from-[#d4a373] to-[#c94f00] text-white shadow-sm overflow-hidden p-6 text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <button data-testid="shop-go-recipes" onClick={() => onNavigate && onNavigate("ricette")}
          className="lab-3d-card text-left rounded-2xl p-5 bg-white dark:bg-[#1e1e1e] border border-[#2e2e2e] shadow-sm active:scale-98 transition-all flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-[#d4a373]/15 flex items-center justify-center shrink-0"><BookOpen className="w-6 h-6 text-[#d4a373]" /></div>
        ...
        <button data-testid="shop-go-academy" onClick={() => onNavigate && onNavigate("impara")}
          className="lab-3d-card text-left rounded-2xl p-5 bg-white dark:bg-[#1e1e1e] border border-[#2e2e2e] shadow-sm active:scale-98 transition-all flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-[#d4a373]/15 flex items-center justify-center shrink-0"><GraduationCap className="w-6 h-6 text-[#d4a373]" /></div>
          <div className="min-w-0">
