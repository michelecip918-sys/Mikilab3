  ...
  return (
    <div className="pb-8" data-testid="esubero-zero">
      ...
      <div className="space-y-3" data-testid="esubero-recipes">
        {RECIPES.map((r, i) => (
          <div key={r.key} data-testid={`esubero-recipe-${i}`} className="rounded-2xl bg-[#0D1520] dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] overflow-hidden shadow-sm">
            <div className="bg-[#2e8b6f] text-[#0D1520] px-4 py-2.5"><p className="font-display text-base font-bold">{rL(r)}</p></div>
