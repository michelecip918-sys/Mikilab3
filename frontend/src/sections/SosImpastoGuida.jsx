    ...
    <div className="pb-8" data-testid="sos-impasto">
      ...
      {onOpenTool && (
        <button data-testid="sos-open-ai" onClick={() => onOpenTool("diagnosi")}
          className="mt-5 w-full flex items-center justify-center gap-2 rounded-2xl bg-[#ff6b00] hover:bg-[#ff6b00] text-[#121212] font-semibold px-5 py-3.5 active:scale-98 transition-all">
