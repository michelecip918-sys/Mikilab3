              ...
              {isOpen && (
                <div className="px-4 pb-4 space-y-2 text-[13.5px] leading-relaxed">
                  ...
                  <div data-testid={`sos-calibrated-${i}`} className="flex items-center gap-2 mt-1 rounded-2xl shadow-md border border-amber-900/40 px-3 py-2" style={{ background: "#1B2A38", border: "2px solid #64748B" }}>
                    ...
                    <span className="text-[12.5px] font-extrabold" style={{ color: "#64748B" }}>{L("Impasto calibrato con successo da Miki & Sitor", "Teig erfolgreich kalibriert von Miki & Sitor", "Dough successfully calibrated by Miki & Sitor", "Masa calibrada con éxito por Miki & Sitor")}</span>
                  </div>
                </div>
              )}
            </div>
