...
export default function SmartPlannerStressZero() {
  ...
  return (
    <div data-testid="smart-planner" className="bg-slate-900/80 p-6 rounded-2xl border border-orange-500/30 space-y-6">
      <ModuleParams screen="planner" />
      <div className="flex items-start gap-3">
        <span className="w-11 h-11 rounded-2xl bg-orange-500/15 border border-orange-500/40 flex items-center justify-center shrink-0">
          <Moon className="w-6 h-6 text-orange-400" />
        </span>
        <div>
          <h3 className="text-xl font-bold text-orange-400">Smart Planner · Stress-Zero</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-5 bg-slate-950 rounded-2xl border border-slate-800 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-xl p-3 text-orange-300 mt-1 font-mono text-center text-xl font-bold"
            />
          </div>
          <div>
        ...
        <div className="p-5 bg-orange-950/20 border border-orange-800/40 rounded-2xl">
          <span className="text-xs font-bold text-orange-300 uppercase tracking-widest block mb-2">Report Organizzativo</span>
      ...
      <div data-testid="team-balance" className="pt-2 space-y-4">
        ...
        <div className="p-5 bg-teal-950/20 border border-teal-800/40 rounded-2xl space-y-3">
          ...
          <div data-testid="balance-report" className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
            ...
            <div><p className="text-2xl font-black text-orange-300 font-mono" data-testid="balance-perperson">{carichoPersona}</p><span className="text-[10px] text-slate-400 uppercase">Pezzi/persona</span></div>
