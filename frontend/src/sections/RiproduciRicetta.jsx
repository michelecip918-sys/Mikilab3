  ...
  return (
    <div data-testid="riproduci-ricetta" className="pb-8">
      ...
      <div className="relative overflow-hidden rounded-3xl p-6 text-[#121212] shadow-xl mb-4" style={{ background: "linear-gradient(135deg,#ff8a33,#ff6b00 70%)" }}>
        ...
        <p className="text-[#121212]/85 text-sm mt-2 leading-snug">{L("Scegli una ricetta e ti guido passo dopo passo, con Mikila accanto a te e la lista della spesa pronta.", "Wähle ein Rezept und ich führe dich Schritt für Schritt — mit Mikila und fertiger Einkaufsliste.", "Pick a recipe and I'll guide you step by step, with Mikila beside you and the shopping list ready.", "Elige una receta y te guío paso a paso, con Mikila a tu lado y la lista lista.", "Choisis une recette et je te guide pas à pas, avec Mikila et la liste de courses prête.", "یک دستور انتخاب کن تا گام‌به‌گام راهنمایی‌ات کنم.")}</p>
      </div>
