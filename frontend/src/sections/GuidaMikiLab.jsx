...
export default function GuidaMikiLab() {
  ...
  const CARDS = [
    { Icon: ShieldCheck, color: "#ff6b00", t: tri("Gestione Account", "Konto", "Account", "Cuenta"),
  ...
  return createPortal(
    <div data-testid="guida-overlay" className="fixed inset-0 z-[320]" onClick={() => setOpen(false)}>
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div className="sticky top-0 z-10 bg-[#ff6b00] text-white flex items-center justify-between px-4 py-3">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="rounded-2xl bg-[#161616] border border-[#2C2C2C] p-3.5" data-testid="guida-voice">
            <p className="flex items-center gap-2 font-display text-base font-bold text-white mb-1"><Volume2 className="w-5 h-5 text-[#ff6b00]" /> {tri("Voce chiara nel rumore", "Klare Stimme im Lärm", "Clear voice in noise", "Voz clara en ruido")}</p>
