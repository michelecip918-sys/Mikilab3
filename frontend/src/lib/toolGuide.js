...
export const TOOL_GUIDE = {
  ...
  infornate: { it: "Interruttore: aggiunge in fondo al piano una TABELLA INFORNATE — a che ora infornare ogni prodotto, con forno, temperatura e minuti, in ordine per non intasare il forno. 📄 GENERATA nel piano.", de: "Schalter: fügt am Ende des Plans eine BACK-TABELLE hinzu — wann jedes Produkt in den Ofen kommt, mit Ofen, Temperatur und Minuten, in Reihenfolge ohne Ofenstau. 📄 im Plan ERZEUGT.", en: "Switch: adds a BAKING SCHEDULE table at the end — what time to bake each product, with oven, temperature and minutes, ordered to avoid oven jams. 📄 GENERATED in the plan." },
};
