...
const HELP = [
  { kw: ["calcolatrice", "calcolo impasto", "calcolare l'impasto", "calcolare impasto", "percentuali del fornaio", "percentuale del fornaio", "quanto lievito per", "quanta farina per", "bäckerprozente", "baeckerprozente", "teigrechner", "bäckerrechner", "baeckerrechner", "pizzateig rechner", "wie viel hefe für", "wie viel hefe fuer", "dough calculator", "baker's percentage", "bakers percentage", "how much yeast for"], // V127
    it: "La calcolatrice del fornaio è in Home (il riquadro «La calcolatrice del fornaio») e in Strumenti, all'indirizzo mikilab.de/calcolatrice. Scegli cosa impasti, quanti pezzi e di che peso, le farine, l'acqua e il lievito (anche biga, poolish o lievito madre): ti do i grammi, l'acqua alla temperatura giusta e il piano con gli orari. Per la pizza c'è mikilab.de/pizza, per il lievito madre pronto all'ora giusta mikilab.de/rinfresco.",
    de: "Der Bäckerrechner ist auf der Startseite (Kasten „Der Bäckerrechner“) und unter Werkzeuge, Adresse mikilab.de/calcolatrice. Wähle Teig, Stückzahl und Gewicht, Mehle, Wasser und Triebmittel (auch Biga, Poolish oder Sauerteig): du bekommst die Gramm, die richtige Wassertemperatur und den Zeitplan. Für Pizza gibt es mikilab.de/pizza, für pünktlich aktiven Sauerteig mikilab.de/rinfresco.",
    en: "The baker's calculator is on the Home page (the \"The baker's calculator\" box) and under Tools, at mikilab.de/calcolatrice. Pick your dough, how many pieces and how heavy, the flours, water and leavening (biga, poolish or sourdough too): you get the grams, the right water temperature and a schedule. For pizza there's mikilab.de/pizza, for a starter ready on time mikilab.de/rinfresco." },
