      ...
      {alarm && (
        <div data-testid="timer-alarm-overlay"
          ...
          <div className="bg-card dark:bg-background rounded-3xl p-8 shadow-2xl max-w-sm w-full">
            ...
            <h2 className="font-display text-3xl font-bold text-foreground dark:text-foreground mt-1 mb-6 break-words">{alarm.name || tri("Timer", "Timer", "Timer")}</h2>
            <button data-testid="timer-alarm-dismiss" onClick={() => dismiss(alarm.id)}
              className="w-full bg-primary hover:bg-accent text-white font-bold text-lg py-5 rounded-2xl active:scale-97 transition-all flex items-center justify-center gap-2">
