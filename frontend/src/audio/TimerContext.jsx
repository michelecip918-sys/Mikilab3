    ...
    <TimerCtx.Provider value={{ timers, nowTs, addTimer, toggle, reset, remove }}>
      ...
      {alarm && (
        <div data-testid="timer-alarm-overlay"
          ...
          <div className="bg-white dark:bg-[#0D1520] rounded-3xl p-8 shadow-2xl max-w-sm w-full">
            ...
            <button data-testid="timer-alarm-dismiss" onClick={() => dismiss(alarm.id)}
              className="w-full bg-[#3E9C93] hover:bg-[#64748B] text-white font-bold text-lg py-5 rounded-2xl active:scale-97 transition-all flex items-center justify-center gap-2">
