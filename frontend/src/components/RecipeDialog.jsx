        ...
        <div className="space-y-3 py-1">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full bg-white dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] focus:border-[#ff6b00] focus:ring-2 focus:ring-[#ff6b00]/20 rounded-xl p-3 text-base outline-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 w-full bg-white dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] focus:border-[#ff6b00] rounded-xl p-3 text-base outline-none"
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center bg-[#e4eff8] dark:bg-[#1e1e1e] rounded-xl border border-[#2e2e2e] dark:border-[#2e2e2e] p-0.5">
                ...
                <div key={key}>
                  ...
                  <div className="relative mt-1">
                    <input
                      ...
                      className="w-full font-mono-data bg-white dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] focus:border-[#ff6b00] focus:ring-2 focus:ring-[#ff6b00]/20 rounded-xl p-3 pr-8 text-base outline-none"
                    />
          ...
          {hydration != null && (
            <div className="flex items-center justify-between bg-[#ff6b00]/15 border border-[#ff6b00]/30 rounded-xl px-4 py-2.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full font-mono-data bg-white dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] focus:border-[#ff6b00] rounded-xl p-3 text-base outline-none"
                />
              </div>
              <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="mt-1 w-full bg-white dark:bg-[#181818] border border-[#2e2e2e] dark:border-[#2e2e2e] focus:border-[#ff6b00] focus:ring-2 focus:ring-[#ff6b00]/20 rounded-xl p-3 text-base outline-none resize-none"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-2 flex-wrap">
              {form.image_url ? <img src={form.image_url} alt="" className="w-16 h-16 rounded-xl object-cover border border-[#2e2e2e] dark:border-[#2e2e2e]" /> : null}
              ...
              <label data-testid="recipe-photo-attach" className={`cursor-pointer bg-[#e4eff8] dark:bg-[#1e1e1e] border border-[#2e2e2e] dark:border-[#2e2e2e] rounded-xl px-4 py-2.5 text-sm font-medium flex items-center gap-2 text-[#2B303B] dark:text-[#e4eff8] ${uploading ? "opacity-60 pointer-events-none" : ""}`}>
          ...
          <div className="pt-2 border-t border-[#2e2e2e] dark:border-[#2e2e2e]" data-testid="recipe-costing-section">
            ...
            {prodCost > 0 && (
              <div className="mt-3 space-y-1.5 bg-[#e4eff8] dark:bg-[#1e1e1e] rounded-xl p-3" data-testid="cost-summary">
