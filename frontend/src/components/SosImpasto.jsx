    ...
    <div className="fixed inset-0 z-[75] flex items-end sm:items-center justify-center" data-testid="sos-panel">
      ...
      <div className="relative w-full sm:max-w-md bg-white dark:bg-[#0E1620] rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[88vh] flex flex-col overflow-hidden">
        ...
        <div className="p-4 overflow-y-auto space-y-3">
          ...
          {recLoading && !rec && (
            <p className="text-[11px] text-[#3E9C93] text-center flex items-center justify-center gap-1.5"><Loader2 className="w-3.5 h-3.5 animate-spin" /> {tri("Cerco la ricetta più adatta…", "Suche das passende Rezept…", "Finding the best recipe…", "Buscando la mejor receta…")}</p>
          )}
        </div>
      </div>
    </div>
