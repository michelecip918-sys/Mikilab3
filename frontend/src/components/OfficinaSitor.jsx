...
export default function OfficinaSitor({ recipes, t }) {
  ...
  const pages = [
    ...
    { k: "collezioni", I: Layers, route: "collezioni", l: tri("Le collezioni", "Die Sammlungen", "The collections"), s: tri("le ricette per come si usano", "die Rezepte nach Gebrauch", "recipes by how they're used") },
    { k: "domande", I: HelpCircle, route: "domande", l: tri("Le domande del fornaio", "Die Fragen des Bäckers", "The baker's questions"), s: tri("49 risposte pronte, senza IA", "49 fertige Antworten, ohne KI", "49 ready answers, no AI") },
