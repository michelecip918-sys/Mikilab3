...
import { Search, ArrowLeftRight, Eye, AlertTriangle, Scissors, Sparkles, Footprints, Factory, Wine, Users, ScrollText, BookOpen, Briefcase } from "lucide-react";
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 snap-x">
        ...
        {pages.map((x) => (
          <button key={x.k} data-testid={`officina-${x.k}`} onClick={() => nav(x.route)}
            className="snap-start shrink-0 w-[150px] text-left rounded-xl border border-primary/40 bg-primary/8 p-2.5 active:scale-[0.98] hover:border-primary transition-all">
