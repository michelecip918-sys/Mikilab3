...
import { Search, ArrowLeftRight, Eye, AlertTriangle, Scissors, Sparkles, Footprints, Factory, Wine, Users, ScrollText, BookOpen, Briefcase, Map, Sun, Wheat } from "lucide-react";
...
export default function OfficinaSitor({ recipes, t }) {
  ...
  const pages = [
    ...
    { k: "pasta", I: Wheat, route: "pasta", l: tri("La pasta di casa", "Hausgemachte Pasta", "Homemade pasta"), s: tri("acqua e farina, dodici forme (di Sitor)", "Wasser und Mehl, zwölf Formen (von Sitor)", "water and flour, twelve shapes (by Sitor)") },
