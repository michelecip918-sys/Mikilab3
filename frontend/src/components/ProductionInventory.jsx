  ...
  return (
    <div data-testid="production-inventory" className="fixed inset-0 z-[80] bg-[#030712]/97 backdrop-blur-xl overflow-y-auto">
      <div className="max-w-2xl mx-auto p-4 pb-16">
        ...
        <p className="text-[12px] text-[#94A3B8] mb-4">{tri("Miki-Nexus legge le consegne dalla foto, tiene le scorte e aggancia i batch alla linea — senza uffici né scartoffie.", "Miki-Nexus liest Lieferungen per Foto, führt den Bestand und verknüpft Chargen mit der Linie — ohne Büro/Papierkram.", "Miki-Nexus reads deliveries from a photo, tracks stock and binds batches to the line — no office, no paperwork.", "Miki-Nexus lee las entregas por foto, controla el stock y vincula lotes a la línea — sin oficina ni papeleo.", "Miki-Nexus lit les livraisons par photo, suit le stock et lie les lots à la ligne — sans bureau ni paperasse.", "Miki-Nexus تحویل‌ها را از عکس می‌خواند و موجودی را مدیریت می‌کند — بدون کاغذبازی.")}</p>
