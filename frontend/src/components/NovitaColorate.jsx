      ...
      <div className="grid grid-cols-3 gap-2">
        {items.map((r) => (
          <button key={r.id} data-testid={`novita-card-${r.id}`} onClick={() => open(r)}
            className="text-left rounded-xl overflow-hidden bg-[#f8fbfe] dark:bg-[#1F252B] border border-[#d5e4f0] dark:border-[#38424B] shadow-sm active:scale-97 transition-all">
