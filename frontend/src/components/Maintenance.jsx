...
export default function Maintenance() {
  return (
    <div data-testid="maintenance-screen" className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden"
      style={{ background: "linear-gradient(160deg,#c94f00 0%,#121212 100%)" }}>
      <div className="relative z-10 max-w-md">
        ...
        <div className="h-1.5 w-40 mx-auto my-5 rounded-full" style={{ background: "linear-gradient(90deg,#D4AF37,#c94f00)" }} />
