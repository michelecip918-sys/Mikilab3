...
export default function ModeBadge() {
  ...
  return (
    <button data-testid="mode-badge" onClick={() => window.dispatchEvent(new Event("mikilab-open-menu"))}
      className={`fixed top-1.5 left-1/2 -translate-x-1/2 z-[45] inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10.5px] font-extrabold uppercase tracking-wide shadow-md border active:scale-95 transition-all ${pro ? "bg-[#ff6b00] text-white border-[#ff6b00]" : "bg-[#161616]/90 backdrop-blur text-[#ff6b00] border-[#ff6b00]/55"}`}>
