  ...
  return (
    <div className="pb-40" data-testid="energia-tool">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-11 h-11 rounded-2xl bg-[#3E9C93] flex items-center justify-center"><Zap className="w-6 h-6 text-white" /></div>
        <div>
      ...
      <div className="rounded-3xl bg-gradient-to-br from-[#3E9C93] to-[#8f3a32] text-white p-5 shadow-lg space-y-3">
