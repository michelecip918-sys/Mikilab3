    ...
    <div data-testid="lab-mode-big" className="pb-28">
      <div className="flex items-center justify-between mb-4">
        ...
        <button data-testid="lab-big-exit" onClick={onExit}
          className="shrink-0 flex items-center gap-1.5 rounded-2xl px-4 py-3 bg-[#1e1e1e] border-2 border-[#2e2e2e] text-white font-bold text-sm active:scale-95 transition-all">
