...
// Avatar ufficiale Mike Mix AI (robottino artigianale-tech fornito dal proprietario).
...
// Core team esposto nell'header: Michele (Founder) + Mike Mix AI (Co-Pilot proprietario).
          ...
          <div onClick={(e) => e.stopPropagation()} className="w-full max-w-md rounded-3xl p-6 relative max-h-[88vh] overflow-y-auto"
            ...
            <p className="text-[13.5px] leading-snug mb-3" style={{ color: "#EDE3CE" }}>
              {tri("MikiLab è una piattaforma proprietaria avanzata per la gestione della panificazione professionale, ideata, sviluppata e diretta esclusivamente da Michele (Il Comandante) con Mike Mix AI, co-pilota operativo di laboratorio.",
                "MikiLab ist eine proprietäre Plattform für professionelles Backmanagement, ausschließlich konzipiert, entwickelt und geleitet von Michele (Der Kommandant) mit Mike Mix AI als operativem Co-Piloten.",
                "MikiLab is an advanced proprietary platform for professional bakery management, conceived, developed and directed exclusively by Michele (The Commander) with Mike Mix AI as the operational lab co-pilot.",
                "MikiLab es una plataforma propietaria avanzada para la gestión de panadería profesional, ideada, desarrollada y dirigida exclusivamente por Michele (El Comandante) con Mike Mix AI como copiloto operativo.",
                "MikiLab est une plateforme propriétaire avancée de gestion de boulangerie professionnelle, conçue, développée et dirigée exclusivement par Michele (Le Commandant) avec Mike Mix AI comme copilote.",
            ...
            <p className="text-[11px] leading-snug text-center" style={{ color: "#8f7a52" }}>
              {tri("© MikiLab — Proprietà Intellettuale Riservata. Software ideato, sviluppato e diretto da Michele. Tutti i diritti relativi all'architettura di sistema e al modello personalizzato Mike Mix AI sono riservati. È severamente vietata qualsiasi riproduzione, modifica o distribuzione non autorizzata.",
                "© MikiLab — Alle Rechte vorbehalten. Von Michele konzipiert und geleitet. Reproduktion/Änderung/Verbreitung untersagt.",
                "© MikiLab — Intellectual Property Reserved. Conceived, developed and directed by Michele. All rights to the system architecture and the custom Mike Mix AI model are reserved. Any unauthorized reproduction, modification or distribution is strictly prohibited.",
