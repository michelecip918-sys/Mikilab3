      ...
      {open && !authOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl border border-[#3E9C93]/40"
            style={{ background: "linear-gradient(160deg,#3E9C93 0%,#3E9C93 55%,#3E9C93 100%)" }}
          >
              ...
              {done ? (
                ...
                <form onSubmit={submit} className="mt-4 flex flex-col gap-2">
                  <input
                    ...
                    className="rounded-2xl bg-white/95 text-[#3E9C93] px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#3E9C93] placeholder:text-[#8a7a63]"
                  />
                  <button data-testid="newsletter-popup-submit" type="submit" disabled={!valid || busy}
                    className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#3E9C93] text-white font-bold text-sm px-5 py-3 shadow-lg active:scale-97 transition-all disabled:opacity-50">
