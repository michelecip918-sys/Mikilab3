...
export default function BakemixGuide() {
  ...
  const CH = [
    ...
    { icon: ShieldCheck, t: tri("Il Capo (Michele)", "Der Chef (Michele)", "The Capo (Michele)", "El Capo (Michele)", "Le Capo (Michele)", "کاپو (میکله)"),
    ...
    <div data-testid="bakemix-guide" className="space-y-4">
      <div className="flex items-center gap-3 p-4 rounded-2xl bg-gradient-to-r from-[#06b6d4]/10 to-transparent border border-[#06b6d4]/30">
        ...
        <div className="min-w-0">
          <h3 className="text-sm font-extrabold text-[#06b6d4]">{tri("Bakemix ti spiega tutto", "Bakemix erklärt alles", "Bakemix explains everything", "Bakemix te explica todo", "Bakemix explique tout", "بیک‌میکس همه‌چیز را توضیح می‌دهد")}</h3>
