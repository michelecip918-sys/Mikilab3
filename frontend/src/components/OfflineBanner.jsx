...
export default function OfflineBanner() {
  ...
  return (
    <div data-testid="offline-banner" className="fixed top-0 left-0 right-0 z-[60] bg-[#3E9C93] text-white text-[13px] font-semibold px-4 py-2 flex items-center justify-center gap-2 shadow-md">
