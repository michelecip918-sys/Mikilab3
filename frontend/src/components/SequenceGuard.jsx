...
// Sitor Sequence Guard: mostra la coda dei lotti in ordine e BLOCCA l'avvio
  ...
  return (
    <div data-testid="sequence-guard" className="rounded-2xl bg-[#0b0f19] border border-[#1e293b] p-4">
      <p className="text-[11px] font-black uppercase tracking-widest text-[#D95200] flex items-center gap-1.5 mb-3">
        <ListOrdered className="w-4 h-4" /> {tri("Sequenza lotti · Sitor", "Chargen-Reihenfolge · Sitor", "Batch sequence · Sitor", "Secuencia de lotes · Sitor", "Séquence des lots · Sitor", "ترتیب دسته‌ها · Sitor")}
      </p>
      ...
      {block && (
        <div data-testid="sequence-block-banner" className="mt-3 rounded-xl border border-[#f59e0b]/50 bg-[#f59e0b12] p-2.5 flex items-center gap-2 animate-fadeIn">
          <img src={`${PUB}/avatar_nexus.jpg`} alt="Sitor" className="w-8 h-8 rounded-full object-cover border border-[#f59e0b]" />
