...
export default function InstallBanner() {
  ...
  return (
    <div data-testid="install-banner" className="max-w-xl mx-auto px-4 mt-2">
      <div className="flex items-center gap-3 rounded-2xl bg-[#2B303B] text-white px-4 py-2.5 shadow-lg border border-[#e7d5b4]/30">
        <div className="w-8 h-8 rounded-xl bg-[#e7d5b4]/20 flex items-center justify-center shrink-0">
          <Download className="w-4 h-4 text-[#e7d5b4]" />
        </div>
        ...
        <button data-testid="install-banner-btn" onClick={install}
          className="shrink-0 bg-[#8C4A27] hover:bg-[#336a94] text-white text-sm font-semibold px-3 py-1.5 rounded-xl active:scale-95 transition-all">
          {t("install_app")}
        </button>
