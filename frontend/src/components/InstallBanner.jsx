...
export default function InstallBanner() {
  ...
  return (
    <div data-testid="install-banner" className="max-w-xl mx-auto px-4 mt-2">
      <div className="flex items-center gap-3 rounded-2xl bg-[#2B303B] text-white px-4 py-2.5 shadow-lg border border-[#3E9C93]/30">
        <div className="w-8 h-8 rounded-2xl shadow-md border border-amber-900/40 bg-[#3E9C93]/20 flex items-center justify-center shrink-0">
          <Download className="w-4 h-4 text-[#3E9C93]" />
        </div>
