  ...
  return (
    <div data-testid="install-banner" className="max-w-xl mx-auto px-4 mt-2">
      <div className="flex items-center gap-3 rounded-2xl bg-[#2B303B] text-white px-4 py-2.5 shadow-lg border border-[#ff6b00]/30">
        <div className="w-8 h-8 rounded-2xl shadow-md border border-amber-900/40 bg-[#ff6b00]/20 flex items-center justify-center shrink-0">
        ...
        <button data-testid="install-banner-btn" onClick={install}
          className="shrink-0 bg-[#ff6b00] hover:bg-[#ff8a33] text-white text-sm font-semibold px-3 py-1.5 rounded-2xl shadow-md border border-amber-900/40 active:scale-95 transition-all">
          {t("install_app")}
        </button>
