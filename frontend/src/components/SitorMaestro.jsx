    ...
    <div data-testid="sitor-maestro" className="relative rounded-2xl border border-border/35 bg-background overflow-hidden">
      ...
      <div className="relative z-10 p-4 space-y-3">
        <div className="flex items-center gap-3">
          <img src={`${PUB}/sitor_official.jpg`} alt="Sitor" className="w-11 h-11 rounded-xl object-cover object-top border-2 border-border/60 shrink-0" onError={(e) => { e.currentTarget.style.display = "none"; }} />
