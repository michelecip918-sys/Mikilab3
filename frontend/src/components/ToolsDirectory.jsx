    ...
    <div className="mt-2" data-testid="maestro-tools-directory">
      ...
      {!s && QUICK.length > 0 && (
        <div className="mb-4" data-testid="lab-quick-grid">
          <p className="text-[13px] font-bold uppercase tracking-wide text-[#3E9C93] mb-2">{tri("Strumenti rapidi", "Schnellzugriff", "Quick tools", "Herramientas rápidas")}</p>
      ...
      <div className="relative mb-3">
        ...
        <input data-testid="tools-dir-search" value={q} onChange={(e) => setQ(e.target.value)}
          ...
          className="w-full bg-[#14212C] border border-[#2A3B49] rounded-2xl shadow-md border border-amber-900/40 py-3 ps-10 pe-9 text-base text-white outline-none focus:border-[#3E9C93]" />
