  ...
  return (
    <div className={`mb-3 ${className}`}>
      ...
      <select data-testid={testid} value={value || ""}
        ...
        className="w-full mt-1 bg-[#0D1520] dark:bg-[#1B2A38] border border-[#2A3B49] dark:border-[#2A3B49] rounded-2xl shadow-md border border-amber-900/40 px-3 py-2.5 outline-none text-[#2B303B] dark:text-[#e4eff8]">
