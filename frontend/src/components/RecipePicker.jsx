  ...
  return (
    <div className={`mb-3 ${className}`}>
      ...
      <select data-testid={testid} value={value || ""}
        ...
        className="w-full mt-1 bg-[#f0f6fb] dark:bg-[#1F252B] border border-[#d5e4f0] dark:border-[#38424B] rounded-xl px-3 py-2.5 outline-none text-[#2B303B] dark:text-[#e4eff8]">
