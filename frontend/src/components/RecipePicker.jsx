  ...
  return (
    <div className={`mb-3 ${className}`}>
      ...
      <select data-testid={testid} value={value || ""}
        ...
        className="w-full mt-1 bg-[#121212] dark:bg-[#181818] border border-[#2b2b2b] dark:border-[#2e2e2e] rounded-xl px-3 py-2.5 outline-none text-[#2B303B] dark:text-[#e4eff8]">
