  ...
  return (
    <div className={`mb-3 ${className}`}>
      ...
      <select data-testid={testid} value={value || ""}
        ...
        className="w-full mt-1 bg-[#F6F8F5] dark:bg-[#1F252B] border border-[#D7E1DB] dark:border-[#38424B] rounded-xl px-3 py-2.5 outline-none text-[#2B303B] dark:text-[#EAF0EC]">
