...
export default function Strumenti({ onBack, onNav, features }) {
  ...
  const all = [
    ...
    { route: "piccoli", Icon: BabyIcon, show: true, t: tri("Il pane dei piccoli", "Das Brot der Kleinen", "Bread for little ones"), d: tri("Fare il pane con i bambini dai tre anni: impasto facile, sei forme, cinque regole, il diploma", "Brot backen mit Kindern ab drei: einfacher Teig, sechs Formen, fünf Regeln, die Urkunde", "Baking bread with children from three: easy dough, six shapes, five rules, the diploma") }, // V103
