...
export default function Strumenti({ onBack, onNav, features }) {
  ...
  const all = [
    ...
    { route: "pasta", Icon: WheatIcon, show: true, t: tri("Acqua e farina: la pasta di casa", "Wasser und Mehl: hausgemachte Pasta", "Water and flour: homemade pasta"), d: tri("Dodici forme scritte da Sitor, dalla Basilicata in su: dosi a persona, tecnica, condimento", "Zwölf Formen von Sitor, von der Basilikata aufwärts: Mengen pro Person, Technik, Sauce", "Twelve shapes written by Sitor, from Basilicata upwards: per-person amounts, technique, sauce") }, // V102
