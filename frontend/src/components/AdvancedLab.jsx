    ...
    <div data-testid="advanced-lab" className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-[#94A3B8]">{tri("Plancia avanzata di Miki-Nexus & Mike Mix — dati live.", "Erweiterte Konsole — Live-Daten.", "Advanced console — live data.", "Consola avanzada — datos en vivo.", "Console avancée — données en direct.", "کنسول پیشرفته — داده زنده")}</p>
        </div>
      </div>
