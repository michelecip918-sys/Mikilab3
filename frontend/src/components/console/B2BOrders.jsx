...
export default function B2BOrders() {
  ...
  const inp = "bg-[#0C1019] border border-[#64748B]/30 rounded-lg px-2.5 py-2 text-sm text-white outline-none placeholder:text-[#4b6070]";
  ...
  return (
    <div data-testid="b2b-orders" className="space-y-3">
      <div className="grid grid-cols-2 gap-2">
        ...
        <label className="flex items-center gap-1 bg-[#0C1019] border border-[#64748B]/30 rounded-lg px-2.5 py-2">
      ...
      {data.aggregate.length > 0 && (
        <div data-testid="b2b-aggregate" className="rounded-xl border border-[#64748B]/30 bg-[#64748B]/5 p-3">
          <p className="text-[11px] font-black uppercase tracking-widest text-[#64748B] flex items-center gap-1.5 mb-2"><Wheat className="w-3.5 h-3.5" /> {tri("Fabbisogno impasto", "Teigbedarf", "Dough needed", "Masa necesaria", "Pâte nécessaire", "خمیر لازم")}</p>
