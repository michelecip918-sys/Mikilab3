...
export default function PastaDiCasa({ onBack }) {
  ...
  return (
    <div data-testid="pasta-page" className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      ...
      <div>
        <p className="font-mono-data text-[10px] tracking-[0.25em] uppercase text-primary flex items-center gap-1.5"><Wheat className="w-3 h-3" />{tri("Acqua e farina", "Wasser und Mehl", "Water and flour")}</p>
        <h1 className="font-display text-2xl font-black text-foreground">{tri("La pasta di casa", "Die hausgemachte Pasta", "Homemade pasta")}</h1>
