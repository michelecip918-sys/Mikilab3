...
const OPERATORI = [
  ...
  { id: "mikemix", name: "Sitor", role: "Reparto Produzione · Fornaio", img: "sitor_official.jpg", accent: "#aaa795" },
];
    ...
    <div data-testid="operatore-select" className="fixed inset-0 z-[9999] bg-[#030712] overflow-y-auto">
      <div className="max-w-md mx-auto px-5 py-12">
        ...
        <div className="text-center mb-8">
          <img src={`${process.env.PUBLIC_URL}/logo-emblem.png`} alt="MikiLab" className="w-16 h-16 rounded-2xl mx-auto mb-3 border border-[#D95200]/40 object-cover bg-[#0b0f19]" />
