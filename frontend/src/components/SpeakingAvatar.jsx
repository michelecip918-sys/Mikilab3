...
// who: "lab" (Michele) | "momi" (Mohamed). mode: "listening" (blu) | "speaking" (arancio).
const IMG = { lab: "michele-avatar.jpg", momi: "mohammed-avatar.jpg" };
...
export default function SpeakingAvatar({
  ...
  const color = mode === "listening" ? "#3B82F6" : "#FF6B00";
