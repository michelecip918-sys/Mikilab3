...
export default function AvatarHub({ onSelect, onLogin, isLoggedIn = false }) {
  ...
  const CARDS = [
    ...
    { kind: "guida", img: "avatar_bigmix.jpg", name: "BakoMix AI", role: tri("Assistente AI · Ti spiega tutto", "KI-Assistent · Erklärt alles", "AI Assistant · Explains everything", "Asistente IA · Te explica todo", "Assistant IA · Explique tout", "دستیار هوش مصنوعی · همه‌چیز را توضیح می‌دهد"), accent: "#06b6d4" },
  ];
