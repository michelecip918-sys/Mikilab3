...
const MOODS = {
  sereno:  { color: "hsl(var(--primary))", base: 110.0, fifth: 164.8, filter: 620,  pulse: 55, drive: 0.0 },
  attivo:  { color: "hsl(var(--muted-foreground))", base: 123.5, fifth: 185.0, filter: 820,  pulse: 60, drive: 0.06 },
  teso:    { color: "hsl(var(--muted-foreground))", base: 138.6, fifth: 196.0, filter: 1050, pulse: 62, drive: 0.14 },
  critico: { color: "hsl(var(--mattone))", base: 155.6, fifth: 208.0, filter: 1500, pulse: 66, drive: 0.24 },
};

export const auraColor = (mood) => (MOODS[mood] || MOODS.sereno).color;

// Ogni postazione di Sitor ha una "voce" diversa: il forno è caldo e brillante,
