...
const GUIDE = [
  { id: "intro", Icon: BookOpen, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "accessi", Icon: KeyRound, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "piano", Icon: CalendarDays, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "ordini", Icon: Zap, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "squadra", Icon: Users, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "strumenti", Icon: Wrench, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "sitor", Icon: Sparkles, accent: "hsl(var(--muted-foreground))",
  ...
  { id: "produzione", Icon: Factory, accent: "hsl(var(--muted-foreground))",
...
export default function GuidaMikiLab({ open, onClose }) {
  ...
  const downloadPdf = () => {
    ...
    const html = `<!doctype html><html lang="${L}"${rtl}><head><meta charset="utf-8"><title>Guida MikiLab Pro</title>
      ...
      .head{display:flex;align-items:center;gap:14px;border-bottom:3px solid hsl(var(--muted-foreground));padding-bottom:14px;margin-bottom:22px}
          ...
          <div className="min-h-screen px-4 py-6 sm:px-6 sm:py-10 max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-6 sticky top-0 z-10 bg-background/90 backdrop-blur py-2 -mx-2 px-2">
              ...
              <button data-testid="guida-pdf-btn" onClick={downloadPdf} title="PDF"
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-muted/15 border border-border/45 text-muted-foreground font-bold text-xs active:scale-95 transition-all">
              ...
              <button data-testid="guida-close-btn" onClick={onClose}
                className="w-9 h-9 rounded-lg bg-background border border-border text-foreground flex items-center justify-center active:scale-95"><X className="w-4 h-4" /></button>
            </div>
              ...
              {GUIDE.map((s, i) => {
                ...
                return (
                  <motion.div key={s.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
                    data-testid={`guida-section-${s.id}`} className="rounded-2xl border border-border bg-background/60 p-4 sm:p-5">
                    <div className="flex items-center gap-2.5 mb-2">
                      ...
                      <h2 className="font-display text-sm sm:text-base font-black text-foreground uppercase tracking-wide">{c.t}</h2>
                    </div>
                    <p className="text-[13px] text-foreground leading-snug mb-2.5">{c.p}</p>
                    <ul className="space-y-1.5">
                      {c.b.map((x, k) => (
                        <li key={k} className="flex gap-2 text-[13px] text-muted-foreground leading-snug">
            ...
            <button data-testid="guida-bottom-close" onClick={onClose}
              className="mt-6 w-full py-3 rounded-xl bg-background border border-border text-muted-foreground font-bold text-sm active:scale-95">
              {label.close}
            </button>
          </div>
        </motion.div>
