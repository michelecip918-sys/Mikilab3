      ...
      <div className="max-w-2xl mx-auto p-4 pb-16">
        ...
        {omni && (
          <div data-testid="enterprise-omni" className="rounded-2xl border border-[#64748B]/40 p-3 mb-4" style={{ background: "linear-gradient(135deg,#64748B18,transparent)" }}>
            <p className="text-[11px] font-black uppercase tracking-widest text-[#7DA3C0] flex items-center gap-1.5"><Sparkles className="w-4 h-4" /> {tri("Sitor Omni-Intelligence", "Omni-Intelligenz", "Omni-Intelligence", "Omni-Inteligencia", "Omni-Intelligence", "هوش کل‌نگر")}</p>
        ...
        {sel && layout && (
          <div data-testid="enterprise-map" className="mb-5">
            ...
            <p className="text-[10px] text-[#64748B] mt-1">{tri("Trascina i macchinari: Sitor ricalcola il risparmio.", "Geräte ziehen: Sitor rechnet die Ersparnis.", "Drag equipment: Sitor recomputes savings.", "Arrastra máquinas: Sitor recalcula.", "Glisse les machines : Sitor recalcule.", "دستگاه‌ها را بکش: Sitor صرفه‌جویی را حساب می‌کند.")}</p>
          </div>
        )}
        ...
        {/* Fleet advice */}
        <p className="text-[11px] font-black uppercase tracking-widest text-[#94A3B8] mb-2 flex items-center gap-1.5"><Sparkles className="w-4 h-4" /> {tri("Consiglio strategico Sitor", "Sitor Strategie", "Sitor strategy", "Estrategia Sitor", "Stratégie Sitor", "استراتژی Sitor")}</p>
        <div className="space-y-1.5">
          {fleet.map((f, i) => (
