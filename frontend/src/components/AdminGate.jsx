...
export default function AdminGate({ onUnlock, onBack }) {
  ...
  return (
    <div data-testid="admin-gate" className="relative min-h-screen overflow-hidden bg-[#030712] text-white flex flex-col items-center justify-center px-6">
      ...
      {onBack && (
        <button data-testid="admin-gate-back" onClick={onBack} className="absolute top-4 left-4 z-20 inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#0b0f19]/80 border border-[#1e293b] text-[#94A3B8] text-xs font-bold hover:border-[#14b8a6] active:scale-95 transition-all backdrop-blur-md">
      ...
      <div className="relative z-10 w-full max-w-xs text-center">
        ...
        <div data-testid="admin-gate-request" className="mt-7 pt-5 border-t border-[#1e293b]">
          ...
          <a href="mailto:accessi@mikilab.de?subject=Richiesta%20accesso%20MikiLab" data-testid="admin-gate-email"
            className="mt-2 inline-flex items-center gap-1.5 text-[12px] font-bold text-[#14b8a6] hover:text-[#2dd4bf] transition-colors">
