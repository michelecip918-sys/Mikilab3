    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-32 h-32 flex items-center justify-center">
          ...
          <div className="splash-logo relative w-24 h-24 rounded-3xl overflow-hidden border border-[#FF6B00]/40 bg-[#030712]">
        ...
        <h1 className="splash-title mt-7 font-cyber text-3xl sm:text-4xl font-black tracking-[0.18em] text-white uppercase">
          MIKILAB<span className="text-[#FF6B00]"> PRO</span>
        </h1>
        <p className="font-mono-data text-[10px] sm:text-[11px] uppercase tracking-[0.38em] text-[#FF6B00]/70 mt-2.5">
