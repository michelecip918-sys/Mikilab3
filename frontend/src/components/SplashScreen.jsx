...
export default function SplashScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 opacity-[0.18] bg-[linear-gradient(to_right,#00F0FF14_1px,transparent_1px),linear-gradient(to_bottom,#00F0FF14_1px,transparent_1px)] bg-[size:3rem_3rem]" />
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-32 h-32 flex items-center justify-center">
          ...
          <div className="splash-logo relative w-24 h-24 rounded-3xl overflow-hidden border border-[#00F0FF]/40 bg-[#030712]">
        ...
        <h1 className="splash-title mt-7 font-cyber text-3xl sm:text-4xl font-black tracking-[0.18em] text-white uppercase">
          MIKILAB<span className="text-[#00F0FF]"> PRO</span>
        </h1>
        <p className="font-mono-data text-[10px] sm:text-[11px] uppercase tracking-[0.38em] text-[#00F0FF]/70 mt-2.5">
