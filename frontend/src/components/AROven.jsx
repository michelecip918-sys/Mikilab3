...
export default function AROven() {
  ...
  const scanOven = async () => {
    ...
    try {
      // Collegato al motore reale di Mike Mix: ricalcolo per la ricetta scelta.
      ...
      setGuide({
        ...
        note: data.summary || tri("Adattato da Mike Mix per il tuo forno.", "Von Mike Mix angepasst.", "Adapted by Mike Mix for your oven.", "Adaptado por Mike Mix.", "Adapté par Mike Mix.", "تنظیم شد."),
        live: true,
      });
    } catch { fallback(); }
    setScanning(false);
