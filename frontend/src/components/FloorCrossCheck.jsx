    ...
    <div data-testid="floor-crosscheck" className="w-full rounded-2xl bg-[#0b0f19] border border-[#06b6d4]/40 p-4 space-y-3 text-left">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-[#94A3B8]">{tri("Scatta la foto del lavoro finito: Sitor la valida.", "Foto der fertigen Arbeit: Sitor prüft.", "Snap the finished work: Sitor validates.", "Foto del trabajo terminado: Sitor valida.", "Photo du travail fini : Sitor valide.", "عکس کار تمام‌شده: باکومیکس تأیید می‌کند.")}</p>
        </div>
      </div>
