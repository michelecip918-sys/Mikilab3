...
const CAPS = [
  ...
  { icon: Languages, tag: "i18n", color: "#3E9C93",
    ...
    b: (l) => mkTri(l)("UI, ricette e audio Sitor in 6 lingue, per una squadra internazionale.", "UI, Rezepte und Sitor-Audio in 6 Sprachen für ein internationales Team.", "UI, recipes and Sitor audio in 6 languages for an international team.", "UI, recetas y audio Sitor en 6 idiomas para un equipo internacional.", "UI, recettes et audio Sitor en 6 langues pour une équipe internationale.", "رابط، دستورها و صدای باکومیکس در ۶ زبان.") },
  { icon: Cpu, tag: "ai", color: "#64748B",
    t: (l) => mkTri(l)("Core Sitor", "Sitor-KI-Kern", "Sitor Core", "Núcleo Sitor IA", "Cœur Sitor IA", "هسته هوش باکومیکس"),
