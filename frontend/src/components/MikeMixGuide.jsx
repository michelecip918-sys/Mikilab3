...
export default function MikeMixGuide() {
  ...
  const CH = [
    ...
    { icon: Mic, t: tri("La produzione con Sitor", "Produktion mit Sitor", "Production with Sitor", "Producción con Sitor", "Production avec Sitor", "تولید با Sitor"),
      b: tri("In produzione tocchi l'avatar di Sitor: ti legge il piano del Capo a voce, passo dopo passo. Di' «avanti», «indietro», «ripeti».", "In der Produktion tippst du Sitor an: er liest den Plan vor. Sag «weiter», «zurück», «nochmal».", "In production you tap Sitor: he reads the Capo's plan aloud. Say «next», «back», «repeat».", "En producción tocas a Sitor: te lee el plan en voz alta. Di «siguiente», «atrás», «repite».", "En production tu touches Sitor : il lit le plan à voix haute. Dis «suivant», «précédent», «répète».", "در تولید روی Sitor می‌زنی: برنامه را با صدا می‌خواند. بگو «بعدی»، «قبلی»، «تکرار».") },
    ...
    <div data-testid="bakemix-guide" className="space-y-4">
      <div className="flex items-center gap-3 p-4 rounded-2xl bg-gradient-to-r from-[#06b6d4]/10 to-transparent border border-[#06b6d4]/30">
        ...
        <div className="min-w-0">
          <h3 className="text-sm font-extrabold text-[#06b6d4]">{tri("Sitor ti spiega tutto", "Sitor erklärt alles", "Sitor explains everything", "Sitor te explica todo", "Sitor explique tout", "Sitor همه‌چیز را توضیح می‌دهد")}</h3>
