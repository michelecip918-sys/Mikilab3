    ...
    <div data-testid="primopane-page" className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      ...
      {count === 7 && (
        <div data-testid="pp-finished" className="rounded-2xl border border-salvia/40 bg-salvia/8 p-3 space-y-2">
          ...
          <p className="text-[12px] text-foreground/85 text-center">{tri("Ecco il tuo attestato: mettici il nome, condividilo, appendilo in cucina.", "Hier ist deine Urkunde: Name eintragen, teilen, in die Küche hängen.", "Here is your certificate: add your name, share it, hang it in the kitchen.")}</p>
          <Attestato lang={lang} />
        </div>
      )}
    </div>
